<x-layout>
  ...
  <div class="mt-5 max-w-lg mx-auto  bg-white dark:bg-gray-800 rounded-lg shadow-md px-8 py-10 flex flex-col items-center">
    <h1 class="text-4xl font-bold text-center text-gray-700 dark:text-gray-200 mb-8">Login</h1>
    ...
    @method('POST')
      ...
      <div class="flex items-start flex-col justify-start">
        ...
        <input type="email" id="email" name="email" class="w-full px-3 dark:text-gray-900 dark:bg-gray-900 py-2 rounded-md border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500">
      </div>
